...
export async function seedBadgesAndQuests(prisma: PrismaClient) {
  ...
  const badges = [
    // Special badges
    {
      ...
      imageUrl: 'https://via.placeholder.com/64/FFD700/000000?text=FM',
    ...
    },
    {
      ...
      imageUrl: 'https://via.placeholder.com/64/C0C0C0/000000?text=EA',
      category: BadgeCategory.special,
    ...
    },
    {
      ...
      imageUrl: 'https://via.placeholder.com/64/CD7F32/000000?text=PI',
      category: BadgeCategory.special,
    ...
    // Mining badges
    {
      ...
      imageUrl: 'https://via.placeholder.com/64/8B4513/FFFFFF?text=M1',
    ...
    },
    {
      ...
      imageUrl: 'https://via.placeholder.com/64/4169E1/FFFFFF?text=M2',
      category: BadgeCategory.mining,
      rarity: BadgeRarity.rare,
    ...
    },
    {
      ...
      imageUrl: 'https://via.placeholder.com/64/9370DB/FFFFFF?text=M3',
      category: BadgeCategory.mining,
      rarity: BadgeRarity.epic,
    ...
    },
    {
      ...
      imageUrl: 'https://via.placeholder.com/64/FFD700/000000?text=M4',
      category: BadgeCategory.mining,
      rarity: BadgeRarity.legendary,
    ...
    // Engagement badges
    {
      ...
      imageUrl: 'https://via.placeholder.com/64/32CD32/FFFFFF?text=U1',
    ...
    },
    {
      ...
      imageUrl: 'https://via.placeholder.com/64/FF8C00/FFFFFF?text=U2',
      category: BadgeCategory.engagement,
      rarity: BadgeRarity.rare,
      pointsRequirement: 0,
      sortOrder: 21,
    },
    {
      ...
      imageUrl: 'https://via.placeholder.com/64/FF4500/FFFFFF?text=U3',
      category: BadgeCategory.engagement,
      rarity: BadgeRarity.epic,
      pointsRequirement: 0,
      sortOrder: 22,
    },
    {
      ...
      imageUrl: 'https://via.placeholder.com/64/00CED1/FFFFFF?text=C1',
      category: BadgeCategory.engagement,
      rarity: BadgeRarity.common,
      pointsRequirement: 0,
      sortOrder: 23,
    },
    {
      ...
      imageUrl: 'https://via.placeholder.com/64/4682B4/FFFFFF?text=C2',
      category: BadgeCategory.engagement,
      rarity: BadgeRarity.rare,
      pointsRequirement: 0,
      sortOrder: 24,
    },
    {
      ...
      imageUrl: 'https://via.placeholder.com/64/1E90FF/FFFFFF?text=C3',
      category: BadgeCategory.engagement,
      rarity: BadgeRarity.epic,
      pointsRequirement: 0,
      sortOrder: 25,
    ...
    // Social badges
    {
      ...
      imageUrl: 'https://via.placeholder.com/64/FFA500/FFFFFF?text=S1',
    ...
    },
    {
      ...
      imageUrl: 'https://via.placeholder.com/64/FF69B4/FFFFFF?text=S2',
      category: BadgeCategory.social,
      rarity: BadgeRarity.rare,
      pointsRequirement: 0,
      sortOrder: 31,
    },
    {
      ...
      imageUrl: 'https://via.placeholder.com/64/FF1493/FFFFFF?text=S3',
      category: BadgeCategory.social,
      rarity: BadgeRarity.epic,
      pointsRequirement: 0,
      sortOrder: 32,
    },
    {
      ...
      imageUrl: 'https://via.placeholder.com/64/20B2AA/FFFFFF?text=R1',
      category: BadgeCategory.social,
      rarity: BadgeRarity.common,
      pointsRequirement: 0,
      sortOrder: 33,
    },
    {
      ...
      imageUrl: 'https://via.placeholder.com/64/3CB371/FFFFFF?text=R2',
      category: BadgeCategory.social,
      rarity: BadgeRarity.rare,
      pointsRequirement: 0,
      sortOrder: 34,
    },
    {
      ...
      imageUrl: 'https://via.placeholder.com/64/228B22/FFFFFF?text=R3',
      category: BadgeCategory.social,
      rarity: BadgeRarity.epic,
      pointsRequirement: 0,
      sortOrder: 35,
    },
    {
      ...
      imageUrl: 'https://via.placeholder.com/64/006400/FFFFFF?text=R4',
      category: BadgeCategory.social,
      rarity: BadgeRarity.legendary,
      pointsRequirement: 0,
      sortOrder: 36,
