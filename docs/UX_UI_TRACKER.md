...
|---|---|---|---|---|---|---|---|
| F-01 | P1 | mobile | "Space" concept invisible; switcher is an unlabeled logo icon; Hunter profile hides Badges/Quests/Levels | D | open | | needs decision: named control + onboarding vs single shell |
...
| F-07 | P2 | cross | Vocabulary drift: Gems/Projects, Members/Users, BNP/BNT/MCR | D | open | | glossary + rename pass |
...
| F-10 | P2 | mobile | Dead-end "coming soon" entries (Help & Support ×5, Moderation ×2) | D | open | | hide / mark / ship minimal |
...
| F-16 | P2 | mobile | Levels page shows no requirements/progress | D → A | open | | `/levels/me` already has progress |
...
| F-20 | P2 | cross | Hunter path has no beginning (Become Hunter dead, no assignment client) | D | open | | product flow decision |
