...
| F-07 | P2 | cross | Vocabulary drift: Gems/Projects, Members/Users, BNP/BNT/MCR | F + G + H | in-progress | mobile: WS-F branch `worktree-agent-a4eab73085000e67b`; backend: WS-H merged | decided: reconcile Gems/Projects/Updates; glossary; MCR removed everywhere (legacy "Mine Credits" row in dev DB, 2 empty accounts, 0 tx; `*Mcr` fields in mining-admin/wallet-admin services + console types) |
...
| F-20 | P2 | cross | Hunter path has no beginning (Become Hunter dead, no assignment client) | F + G | in-progress | mobile: WS-F branch `worktree-agent-a4eab73085000e67b` | decided: wire Become Hunter (mobile), assign/invite UI (console), invite acceptance (mobile) |
