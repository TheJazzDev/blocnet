...
| **Blocnet Hunter Hub** | [Claude Design](https://claude.ai/design/p/ac45a2a1-0d3c-443e-a3d0-6a5a5e22b701) · *Blocnet Hunter Hub.html* | [`blocnet-hunter-hub.html`](artifacts/blocnet-hunter-hub.html) | **The Hunter Hub we build**, approved 2026-09-16. The hunter's gems are the screen, most in need first; reliability above them as a sentence, reach demoted beside it. Six states plus the row anatomy. Brief: [`hunter-hub.md`](design-briefs/hunter-hub.md); states extracted in [`hunter-hub-build-spec.md`](design-briefs/hunter-hub-build-spec.md). |
| **Blocnet Mine** | [Claude Design](https://claude.ai/design/p/ac45a2a1-0d3c-443e-a3d0-6a5a5e22b701?file=Blocnet+Mine.html) · *Blocnet Mine.html* | [`blocnet-mine.html`](artifacts/blocnet-mine.html) | **The Mine tab we build** — awaiting owner approval. One question, one button: cycle card with a status word, a stated time and a progress ring around the mining core (owner replaced the 24 hour-marks with the ring, 2026-09-16), Balance, Earn faster (referrals merged in), Leaderboard, Hourly history. Twelve states plus two spec panels. Brief: [`mine.md`](design-briefs/mine.md). |
...
| **Start a new session here** | [`design-briefs/NEXT_SESSION.md`](design-briefs/NEXT_SESSION.md) |
