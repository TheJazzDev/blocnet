...
class CreatePostPage extends StatefulWidget {
  ...
  const CreatePostPage({super.key, required this.projectId});
      ...
      body: Form(
        ...
        child: ListView(
          ...
          children: [
            ...
            // Info Card
            if (_selectedType == PostType.urgent)
              Card(
                ...
                child: Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          'Urgent posts will send high-priority notifications to all followers.',
  ...
  Future<void> _createPost(AdminProvider adminProvider) async {
    ...
    if (mounted) {
      if (postId != null) {
        ...
        Helpers.showSnackBar(
          context,
          'Failed to create post: ${adminProvider.error}',
          isError: true,
        );
      }
    }
