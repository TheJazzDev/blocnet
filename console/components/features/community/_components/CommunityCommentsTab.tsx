...
import type { AdminCommunityComment, ContentStatus } from "@/lib/api-client";
import { formatDate, statusBadge, topicBadge, type StatusFilter } from "../_lib/community-admin";

type CommunityCommentsTabProps = {
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        {comment.status !== "active" && (
                          <DropdownMenuItem onClick={() => onModerate(comment, "active")}>
                            Set Active
                          </DropdownMenuItem>
                        )}
                        {comment.status !== "hidden" && (
                          <DropdownMenuItem onClick={() => onModerate(comment, "hidden")}>
                            Set Hidden
                          </DropdownMenuItem>
                        )}
                        <DropdownMenuSeparator />
