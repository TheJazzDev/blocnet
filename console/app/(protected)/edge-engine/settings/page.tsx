            ...
            <CardContent className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setEdgeConfig((prev) =>
                      prev ? { ...prev, mlOllamaTimeout: parseInt(e.target.value, 10) || 120000 } : prev,
                    )
                  }
                  disabled={!canMutateConfig || !edgeConfig || configSaving}
                  min={1000}
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setEdgeConfig((prev) =>
                      prev ? { ...prev, mlCacheTtl: parseInt(e.target.value, 10) || 86400 } : prev,
                    )
                  }
                  disabled={!canMutateConfig || !edgeConfig || configSaving}
                  min={60}
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setEdgeConfig((prev) =>
                      prev ? { ...prev, mlMaxContentLength: parseInt(e.target.value, 10) || 10000 } : prev,
                    )
                  }
                  disabled={!canMutateConfig || !edgeConfig || configSaving}
                  min={1000}
